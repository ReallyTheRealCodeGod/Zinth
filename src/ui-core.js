...
const MOODS={
  chill:   {label:'Chill',       scales:['dorian','pentMajor','mixolydian'],bpm:[80,96],  energy:45,swing:28,human:34,sevenths:true, gate:0.7,kit:'Breaks',arp:{modes:['updown','up','pattern'],octaves:2,gate:75},
            sound:{lead:{vibrato:40,vibRate:40,wave:'fm',fmRatio:1,fmIndex:42,cutoff:68,reso:8,attack:1,decay:55,sustain:45,release:45,spread:8,fenv:10,drive:8,slope:12,chorus:30,delay:40,reverb:40},arp:{wave:'sine',cutoff:60,attack:0,decay:30,sustain:35,release:30,fenv:45,drive:5,slope:12,level:45,delay:50,reverb:35},chords:{wave:'super',cutoff:40,reso:8,attack:50,decay:60,sustain:85,release:65,spread:45,fenv:15,drive:5,slope:12,chorus:50,reverb:55,level:50},bass:{glide:25,wave:'sine',cutoff:38,attack:2,decay:30,sustain:90,release:25,fenv:20,drive:25,slope:24,level:80},drums:{level:60,reverb:25,pump:25}}},
  dreamy:  {label:'Dreamy',      scales:['lydian','major','pentMajor','lydDom'],bpm:[84,100],energy:35,swing:8, human:30,sevenths:true, gate:0.9,kit:'Lo-fi',arp:{modes:['up','updown','chord'],octaves:3,gate:90},
            sound:{lead:{vibrato:55,vibRate:32,wave:'fm',fmRatio:3.5,fmIndex:60,cutoff:80,reso:5,attack:0,decay:65,sustain:25,release:75,spread:12,fenv:0,drive:0,slope:12,chorus:25,delay:55,reverb:60},arp:{wave:'fm',fmRatio:4,fmIndex:28,cutoff:75,attack:0,decay:35,sustain:15,release:35,fenv:0,drive:0,slope:12,level:45,delay:55,reverb:45},chords:{wave:'saw',cutoff:46,reso:5,attack:60,decay:50,sustain:90,release:80,spread:30,fenv:10,drive:5,slope:12,chorus:45,reverb:70,level:55},bass:{glide:35,wave:'sine',cutoff:40,attack:3,decay:30,sustain:90,release:30,fenv:15,drive:15,slope:24,level:75},drums:{level:45,reverb:35,pump:20}}},
  driving: {label:'Driving',     scales:['minor','dorian','pentMinor'],bpm:[124,138],energy:80,swing:0, human:6, sevenths:false,gate:0.55,kit:'909',arp:{modes:['up','pattern','down'],octaves:2,gate:45},
            sound:{lead:{vibrato:18,vibRate:60,wave:'super',cutoff:72,reso:10,attack:2,decay:40,sustain:80,release:35,spread:60,fenv:25,drive:15,slope:12,chorus:20,delay:30,reverb:20},arp:{wave:'saw',cutoff:52,reso:30,attack:0,decay:28,sustain:25,release:20,spread:10,fenv:70,drive:12,slope:24,level:60,delay:35,reverb:20},chords:{wave:'saw',cutoff:48,reso:15,attack:3,decay:30,sustain:40,release:35,spread:20,fenv:45,drive:15,slope:24,chorus:15,level:40,reverb:40},bass:{glide:8,wave:'saw',cutoff:34,reso:20,attack:2,decay:35,sustain:80,release:25,spread:0,fenv:40,drive:45,slope:24,level:85},drums:{level:85,reverb:15,pump:60}}},
  dark:    {label:'Dark',        scales:['phrygian','harmMinor','hirajoshi','insen','phrygDom','hungMinor'],bpm:[92,112],energy:60,swing:6,human:22,sevenths:false,gate:0.6,kit:'Trap',arp:{modes:['down','random','pattern'],octaves:2,gate:55},
            sound:{lead:{vibrato:35,vibRate:45,wave:'saw',cutoff:46,reso:50,attack:2,decay:35,sustain:60,release:40,spread:35,fenv:55,drive:30,slope:24,chorus:15,delay:45,reverb:45},arp:{wave:'saw',cutoff:40,reso:40,attack:0,decay:30,sustain:30,release:25,spread:0,fenv:65,drive:20,slope:24,level:50,delay:50,reverb:35},chords:{wave:'super',cutoff:32,reso:10,attack:60,decay:60,sustain:85,release:70,spread:40,fenv:10,drive:10,slope:24,chorus:35,level:50,reverb:65},bass:{glide:30,wave:'saw',cutoff:30,reso:20,attack:4,decay:40,sustain:80,release:30,spread:80,fenv:25,drive:50,slope:24,level:85},drums:{level:75,reverb:30,pump:45}}},
  retro:   {label:'Retro',       scales:['major','mixolydian','pentMajor'],bpm:[110,124],energy:65,swing:0,human:0, sevenths:false,gate:0.5,kit:'808',arp:{modes:['pattern','up'],octaves:1,gate:40},
            sound:{lead:{vibrato:0,vibRate:60,wave:'square',cutoff:90,reso:0,attack:0,decay:20,sustain:70,release:12,spread:0,fenv:0,drive:0,slope:12,chorus:0,delay:25,reverb:12},arp:{wave:'square',cutoff:90,reso:0,attack:0,decay:15,sustain:60,release:10,spread:0,fenv:0,drive:0,slope:12,level:55,delay:30,reverb:10},chords:{wave:'triangle',cutoff:75,reso:0,attack:3,decay:30,sustain:70,release:30,spread:0,fenv:0,drive:0,slope:12,chorus:0,level:45,reverb:20},bass:{glide:0,wave:'triangle',cutoff:62,reso:0,attack:0,decay:20,sustain:80,release:15,spread:0,fenv:0,drive:0,slope:12,level:85},drums:{level:70,reverb:8,pump:15}}},
  uplift:  {label:'Uplifting',   scales:['major','lydian'],bpm:[126,134],energy:75,swing:0,human:8, sevenths:false,gate:0.6,kit:'House',arp:{modes:['updown','up','chord'],octaves:3,gate:60},
            sound:{lead:{vibrato:25,vibRate:55,wave:'super',cutoff:70,reso:12,attack:4,decay:40,sustain:80,release:40,spread:55,fenv:30,drive:15,slope:12,chorus:25,delay:40,reverb:40},arp:{wave:'saw',cutoff:55,reso:25,attack:0,decay:30,sustain:25,release:25,spread:10,fenv:70,drive:10,slope:24,level:55,delay:45,reverb:30},chords:{wave:'super',cutoff:50,reso:8,attack:30,decay:55,sustain:85,release:60,spread:55,fenv:20,drive:8,slope:12,chorus:45,level:55,reverb:55},bass:{glide:10,wave:'saw',cutoff:38,reso:15,attack:2,decay:35,sustain:80,release:25,spread:0,fenv:35,drive:30,slope:24,level:85},drums:{level:80,reverb:20,pump:65}}},
  odd:     {label:'Otherworldly',scales:['wholeTone','lydian','insen','dorb2','neapMinor'],bpm:[70,100],energy:40,swing:10,human:28,sevenths:true,gate:0.85,kit:'Lo-fi',arp:{modes:['random','chord','updown'],octaves:3,gate:80},
            sound:{lead:{vibrato:60,vibRate:25,wave:'fm',fmRatio:3.5,fmIndex:55,cutoff:78,reso:10,attack:8,decay:70,sustain:30,release:85,spread:20,fenv:0,drive:0,slope:12,chorus:35,delay:60,reverb:70},arp:{wave:'fm',fmRatio:4,fmIndex:30,cutoff:75,attack:0,decay:35,sustain:10,release:35,spread:0,fenv:0,drive:0,slope:12,level:50,delay:60,reverb:50},chords:{wave:'super',cutoff:34,reso:6,attack:80,decay:70,sustain:90,release:90,spread:50,fenv:10,drive:0,slope:12,chorus:55,level:50,reverb:80},bass:{glide:40,wave:'sine',cutoff:36,reso:5,attack:4,decay:35,sustain:90,release:35,spread:0,fenv:15,drive:15,slope:24,level:70},drums:{level:35,reverb:50,pump:20}}},
};
...
const WAVES=[['sine','M2 7q3-7 6 0t6 0 6 0'],['triangle','M2 12l3-10 3 10 3-10 3 10 3-10 3 10'],['saw','M2 12l6-10v10l6-10v10l6-10v10'],['square','M2 12v-10h6v10h6v-10h6v10'],['super','M2 12l4-10v10l4-10v10l4-10v10l4-10v10l4-10v10'],['fm','M2 7q1.5-6 3 0t3 0 3 0 3 0 3 0 3 0 3 0 3 0']];
// The patch library. Every patch sets the whole voice — wave, filter, both envelopes, drive, unison and
// the FM pair — so choosing one is choosing a sound, not a starting point. Chorus rides along where it is
// part of the sound. Names say what you get; the group in the menu says what it is for.
const PATCHES={
  'Init':          {wave:'saw',     cutoff:60,reso:20,attack:5, decay:35,sustain:70,release:30,spread:20,fenv:30,drive:10,slope:12,fmRatio:2,  fmIndex:40},
  'Pluck':         {wave:'saw',     cutoff:50,reso:30,attack:0, decay:30,sustain:25,release:25,spread:10,fenv:70,drive:10,slope:24,fmRatio:2,  fmIndex:40},
  'Analog Brass':  {wave:'saw',     cutoff:50,reso:20,attack:12,decay:40,sustain:70,release:25,spread:12,fenv:60,drive:20,slope:24,fmRatio:2,  fmIndex:40},
  'Supersaw':      {wave:'super',   cutoff:72,reso:10,attack:4, decay:40,sustain:80,release:40,spread:60,fenv:25,drive:15,slope:12,fmRatio:2,  fmIndex:40,chorus:20},
  'Acid':          {wave:'saw',     cutoff:35,reso:75,attack:0, decay:30,sustain:30,release:15,spread:0, fenv:85,drive:40,slope:24,fmRatio:2,  fmIndex:40},
  'Chip':          {wave:'square',  cutoff:90,reso:0, attack:0, decay:20,sustain:70,release:12,spread:0, fenv:0, drive:0, slope:12,fmRatio:2,  fmIndex:40},
  'Hollow':        {wave:'square',  cutoff:42,reso:30,attack:25,decay:50,sustain:80,release:60,spread:25,fenv:20,drive:0, slope:12,fmRatio:2,  fmIndex:40},
  'Juno Pad':      {wave:'super',   cutoff:45,reso:8, attack:55,decay:60,sustain:85,release:70,spread:45,fenv:15,drive:5, slope:12,fmRatio:1,  fmIndex:30,chorus:55},
  'Strings':       {wave:'saw',     cutoff:48,reso:5, attack:55,decay:50,sustain:90,release:75,spread:30,fenv:10,drive:5, slope:12,fmRatio:1,  fmIndex:30,chorus:40},
  'Glass Bell':    {wave:'fm',      cutoff:85,reso:5, attack:0, decay:65,sustain:20,release:75,spread:12,fenv:0, drive:0, slope:12,fmRatio:3.5,fmIndex:70},
  'E-Piano':       {wave:'fm',      cutoff:70,reso:5, attack:0, decay:55,sustain:40,release:40,spread:6, fenv:0, drive:8, slope:12,fmRatio:1,  fmIndex:45,chorus:30},
  'Marimba':       {wave:'fm',      cutoff:80,reso:0, attack:0, decay:35,sustain:10,release:30,spread:0, fenv:0, drive:0, slope:12,fmRatio:4,  fmIndex:30},
  'Keys':          {wave:'triangle',cutoff:65,reso:10,attack:1, decay:45,sustain:55,release:40,spread:8, fenv:35,drive:5, slope:12,fmRatio:2,  fmIndex:40},
  'Sub Bass':      {wave:'sine',    cutoff:40,reso:5, attack:2, decay:30,sustain:90,release:25,spread:0, fenv:20,drive:25,slope:24,fmRatio:1,  fmIndex:25},
  'Reese Bass':    {wave:'saw',     cutoff:30,reso:20,attack:5, decay:40,sustain:80,release:30,spread:80,fenv:25,drive:45,slope:24,fmRatio:1,  fmIndex:25},
  'FM Bass':       {wave:'fm',      cutoff:55,reso:10,attack:0, decay:35,sustain:60,release:20,spread:0, fenv:30,drive:35,slope:24,fmRatio:1,  fmIndex:55},
};
